...
public class ItemsPanel extends JPanel {
	...
	private JList<ItemExtras> itemsList;
	...
	public void setItems(List<ItemExtras> items) {
		itemsList.setListData(items.toArray(new ItemExtras[0]));
	}
		...
		itemsList.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent evt) {
				if (evt.getClickCount() == 2) {
					...
					ItemExtras itemModel = itemsList.getModel().getElementAt(index);
